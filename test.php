...
$codes[] =  $ps->generateCode($ae,$year3,$sem1, $group_a, 50);
$codes[] =  $ps->generateCode($ae,$year3,$sem1, $group_b, 50);
$codes[] =  $ps->generateCode($ae,$year3,$sem1, $group_c, 50);
$codes[] =  $ps->generateCode($ae,$year3,$sem1, $group_d, 50);
...
$codes[] =  $ps->generateCode($ae,$year2,$sem1, $group_d, 50);
...
$codes[] =  $ps->generateCode($ae,$year1,$sem1, $group_d, 50);

/* generating codes for ET department */
$codes[] =  $ps->generateCode($et,$year3,$sem1, $group_a, 50);
$codes[] =  $ps->generateCode($et,$year3,$sem1, $group_b, 50);
$codes[] =  $ps->generateCode($et,$year3,$sem1, $group_c, 50);
$codes[] =  $ps->generateCode($et,$year3,$sem1, $group_d, 50);
...
$codes[] =  $ps->generateCode($et,$year2,$sem1, $group_d, 50);
...
$codes[] =  $ps->generateCode($it,$year3,$sem1, $group_a, 50);
$codes[] =  $ps->generateCode($it,$year3,$sem1, $group_b, 50);
$codes[] =  $ps->generateCode($it,$year3,$sem1, $group_c, 50);
$codes[] =  $ps->generateCode($it,$year3,$sem1, $group_d, 50);
...
$codes[] =  $ps->generateCode($it,$year2,$sem1, $group_d, 50);
...
$codes[] =  $ps->generateCode($it,$year1,$sem1, $group_d, 50);
