...
if (isset($_POST['submit'])) {
    ...
    //$userPass		=	$connPDO->quote(trim($_POST['user_pass']));
    ...
    if ($userName == '') {
        ...
        $loginRes = $connPDO->query($loginQuery);
        $loginArr = $loginRes->fetch(PDO::FETCH_ASSOC);
        ...
        if ($loginArr) {
            if ($loginArr['used'] == 0) {
                ...
                $_SESSION['stud_group'] = $_stinfo['group'];
                $_SESSION['acad_year'] = $_stinfo['academic_year'];

                header("Location: feedback.php");
                exit;
            } else {
                $errorMsg = "This Code Has Been Expired<br /> Please contact system administrator!";
            }
        } else {
                                ...
                                <tr>
                                    ...
                                    <td width = '120' height = '30'>
                                        ...
                                        <span id="sprytextfield1xxx">
                                            <input type = 'password' name = 'user_name' id = 'user_name' maxlength="16" class = 'typeproforms'  />
