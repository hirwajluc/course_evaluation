...
<div class="body">
    <div class="main_body">
		...
		?>
			<tr>
			<th  height="30" align="center"><strong>ID</strong></td>
			<th  height="30" align="center"><strong>Program Code</strong></td>
					...
					<tr>
						...
						<td align="center">
							...
							<a onclick="javascript: return confirm('Sure! Do you want to Delete?');" href="departments_delete.php?id=<?php echo $searchArr["department_id"]?>&keyword=
								<?php $_GET["keyword"]?>&type=p">Delete
							</a>
						</td>
					</tr>
        <?php
