  ...
  <div class="body">
    <div class="main_body">
        ...
        <?php
			...
			$searchQry		=  "SELECT * FROM `tbl_answer` WHERE `answer_type` LIKE '{$keyword}%'
		  ...
		  ?>
		      <tr>
                <th height="30" align="center"><strong>Answer</strong></td>
			...
			?>
					<tr>
						<td height="30">&nbsp;
							<?php 
								echo $searchArr["answer_type"];
							?>
						</td>
						
						<td align="center">
							<a href="answers_edit.php?id=<?php echo $searchArr["answer_id"] ?>&keyword=<?php echo $_GET["keyword"]?>">Edit</a> | 
							<a onclick="javascript: return confirm('Sure! Do you want to Delete?');"
							href="answers_delete.php?id=<?php echo $searchArr["answer_id"]?>&keyword=<?php $_GET["keyword"]?>">
							Delete
							</a>
						</td>
					</tr>
