...
//To Plot Menus in this Page
            ...
            <div class="body">
                <div class="main_body">
					...
					<!--Selection by year-->
					<form action="current_class_wise.php" method="POST">
					<select title="Select year" name="select">
						
							<?php
								for($i=date("Y");$i>=2007;$i--){//Nepo
									echo "<option>".$i."</option>";//Nepo
								}
							?>
						...
						<button name="print">Generate PDF report</button></h2>
					</form>
                    <?php
                ...
                <td height="30" colspan="3" align="center"><strong style="color:red;">Search Not Found</strong></td>
                      ...
                      <!--<th height="30" align="center"><strong>Sub Code</strong></td>-->
                                <th height="30" align="center"><strong>Subject Name</strong></td>
                                    <th height="30" align="center"><strong>Dept Code</strong></td>
                                        <th height="30" align="center"><strong>Year</strong></td>
                                            <th height="30" align="center"><strong>Semester</strong></td>
                                                <th height="30" align="center"><strong>Teacher's Name</strong></td>
