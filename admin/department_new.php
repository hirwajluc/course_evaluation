...
{
	$successMsg		=	"Program Successfully Saved!";	
}
...
{	
	...
	{	
		...
		if($existFlag)
		{
			$errorMsg			=	"Error! Program Already Exists!";
		}	
		else
		{	
			...
			if(!$insertFlag)
			{
				$errorMsg		=	"Error!Unable to save Program!";
			}
		}	
	}	
}	
	...
	<div class="body">
		<div class="main_body">
			...
			<tr>
				<td>&nbsp;</td>
				<td height = '30'>
					<input type = 'submit' name = 'submit' class = 'button' value = 'Add Program' />
				</td>
			</tr>
		  	</table>
			</form><!-- End of form-->
